local options = {
  options = {
    ...
    get_element_icon = function(buf)
      return require 'nvim-web-devicons'.get_icon(vim.api.nvim_buf_get_name(vim.fn.bufnr()), vim.fn.getbufvar(vim.fn.bufnr(), '&filetype'),
      { default = true })
    end, -- whether or not an unrecognised filetype should show a default icon
